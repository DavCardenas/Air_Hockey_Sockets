...
public class Operations {
	 ...
	 */
	public Operations(Socket socket) {
		conection = socket;
		read = true;
		write = true;
					...
					try {
						if (inputStream != null) {
							...
							if (message != null) {
								...
								messageGlobal.setLevel(message.getLevel());
								messageGlobal.setLevel_score(message.getLevel_score());
								messageGlobal.setPlayerCounter(message.getPlayerCounter());
								messageGlobal.setPlayers(message.getPlayers());
								messageGlobal.setPlayerSelf(message.getPlayerSelf());
								messageGlobal.setStartGame(message.isStartGame());
								messageGlobal.setTimeGame(message.getTimeGame());
